...
export const Hero = () => {
  return (
    ...
    <div className="m-[0_7.3rem_3rem_7.3rem] flex flex-col items-center w-[fit-content] box-sizing-border">
      ...
      <a href='/' className="rounded-[0.3rem] bg-[#175CD3] flex flex-row justify-center p-[0.9rem_0rem_0.9rem_0] w-[22.2rem] box-sizing-border hover:bg-blue-600 hover:border-blue-600">
