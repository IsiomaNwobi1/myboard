...
export const Hero = () => {
  return (
    ...
    <div className="flex flex-row w-[80.9rem] box-sizing-border">
      <div className="rounded-[6.3rem] bg-no-repeat bg-[center_right_46%] bg-cover bg-[url('assets/images/Rectangle60.png')] m-[0.7rem_1.5rem_0.5rem_0] w-[11.9rem] h-[37.8rem]">
      </div>
      <div className="rounded-[6.3rem] bg-no-repeat bg-[center_right_70%] bg-cover bg-[url('assets/images/Rectangle61.png')] m-[3.8rem_2.2rem_2.6rem_0] w-[11.9rem] h-[32.6rem]">
      </div>
      <div className="rounded-[6.3rem] bg-no-repeat bg-[center_right_50%] bg-cover bg-[url('assets/images/Rectangle62.png')] m-[0_1.8rem_4.3rem_0] w-[11.9rem] h-[34.7rem]">
      </div>
      <div className="rounded-[6.3rem] bg-no-repeat bg-[center_right_70%] bg-cover bg-[url('assets/images/Rectangle63.png')] m-[4.3rem_2rem_0_0] w-[11.9rem] h-[34.7rem]">
      </div>
      <div className="rounded-[6.3rem] bg-no-repeat bg-[center_right_65%] bg-cover bg-[url('assets/images/Rectangle64.png')] m-[0_1.8rem_4.3rem_0] w-[11.9rem] h-[34.7rem]">
      </div>
      <div className="rounded-[6.3rem] bg-no-repeat bg-[center_right_50%] bg-cover bg-[url('assets/images/Rectangle65.png')] m-[3.8rem_0_0.5rem_0] w-[11.9rem] h-[34.7rem]">
      </div>
    </div>
  </div>
  )
