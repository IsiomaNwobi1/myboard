    ...
    <div className="m-[0_7rem_3rem_7rem] flex flex-row self-start w-[fit-content] box-sizing-border">
      <div className="m-[0.2rem_5.1rem_7.5rem_0] flex flex-col box-sizing-border">
        <div className="m-[0_0.2rem_2.2rem_0.2rem] flex flex-row self-start w-[fit-content] box-sizing-border">
          <a href='/' className="m-[0_0.8rem_0_0] flex flex-row justify-center w-[2.3rem] h-[2.1rem] box-sizing-border">
            <img src={MyBoardBlack} className="w-[2.3rem] h-[2.1rem]" />
          </a>
          <a href='/' className="m-[0.2rem_0_0.1rem_0] inline-block break-words font-['Product_Sans','Roboto_Condensed'] font-normal text-[1.3rem] leading-[1.4] text-[var(--white-1,#FFFFFF)]">
            My Board
          </a>
        </div>
      ...
      <div className="flex flex-row box-sizing-border">
        <div className="m-[0_5.9rem_0_0] flex flex-col box-sizing-border">
          ...
          <div className="flex flex-col w-[fit-content] box-sizing-border">
            <a href='/' className="m-[0_0_0.8rem_0] flex flex-row justify-center self-start box-sizing-border">
            ...
            <a className="m-[0_0_0.8rem_0] flex flex-row justify-center self-start box-sizing-border">
              <p className="break-words font-['Inter'] font-[var(--text-md-medium-font-weight,500)] text-[1rem] leading-[var(--text-md-medium-line-height,1.5)] text-[var(--gray-200,#EAECF0)]">
                Features
              </p>
            </a>
            <div className="m-[0_0_0.8rem_0] flex flex-row w-[fit-content] box-sizing-border">
              <a href='/' className="m-[0_0.6rem_0_0] flex flex-row justify-center box-sizing-border">
                <p className="break-words font-['Inter'] font-[var(--text-md-medium-font-weight,500)] text-[1rem] leading-[var(--text-md-medium-line-height,1.5)] text-[var(--gray-200,#EAECF0)]">
                  Solutions
                </p>
              </a>
            ...
            <a href='/' className="flex flex-row justify-center self-start box-sizing-border">
              <p className="break-words font-['Inter'] font-[var(--text-md-medium-font-weight,500)] text-[1rem] leading-[var(--text-md-medium-line-height,1.5)] text-[var(--gray-200,#EAECF0)]">
                Releases
              </p>
            </a>
        ...
        <div className="m-[0_9.1rem_0_0] flex flex-col items-center box-sizing-border">
          ...
          <div className="flex flex-col w-[fit-content] box-sizing-border">
            <a href='/' className="m-[0_0.1rem_0.8rem_0] flex flex-row justify-center box-sizing-border">
              <p className="break-words font-['Inter'] font-[var(--text-md-medium-font-weight,500)] text-[1rem] leading-[var(--text-md-medium-line-height,1.5)] text-[var(--gray-200,#EAECF0)]">
                About us
              </p>
            </a>
            <a href='/' className="m-[0_0.6rem_0.8rem_0] flex flex-row justify-center box-sizing-border">
              <p className="break-words font-['Inter'] font-[var(--text-md-medium-font-weight,500)] text-[1rem] leading-[var(--text-md-medium-line-height,1.5)] text-[var(--gray-200,#EAECF0)]">
                Careers
              </p>
            </a>
            ...
            <a href='/' className="m-[0_0_0.8rem_0] flex flex-row justify-center box-sizing-border">
              <p className="break-words font-['Inter'] font-[var(--text-md-medium-font-weight,500)] text-[1rem] leading-[var(--text-md-medium-line-height,1.5)] text-[var(--gray-200,#EAECF0)]">
                Media kit
              </p>
            </a>
        ...
        <div className="m-[0_8.8rem_0_0] flex flex-col box-sizing-border">
          ...
          <div className="flex flex-col w-[fit-content] box-sizing-border">
            ...
            <a href='/' className="m-[0_0.7rem_0.8rem_0] flex flex-row justify-center box-sizing-border">
              <p className="break-words font-['Inter'] font-[var(--text-md-medium-font-weight,500)] text-[1rem] leading-[var(--text-md-medium-line-height,1.5)] text-[var(--gray-200,#EAECF0)]">
                LinkedIn
              </p>
            </a>
            ...
            <a href='/' className="m-[0_0.2rem_0.8rem_0] flex flex-row justify-center box-sizing-border">
              <p className="break-words font-['Inter'] font-[var(--text-md-medium-font-weight,500)] text-[1rem] leading-[var(--text-md-medium-line-height,1.5)] text-[var(--gray-200,#EAECF0)]">
                AngelList
              </p>
            </a>
        ...
        <div className="flex flex-col box-sizing-border">
          ...
          <div className="flex flex-col w-[fit-content] box-sizing-border">
            ...
            <a href='/' className="m-[0_0.4rem_0.8rem_0] flex flex-row justify-center box-sizing-border">
              <p className="break-words font-['Inter'] font-[var(--text-md-medium-font-weight,500)] text-[1rem] leading-[var(--text-md-medium-line-height,1.5)] text-[var(--gray-200,#EAECF0)]">
                Cookies
              </p>
            </a>
            ...
            <a href='/' className="m-[0_0.3rem_0.8rem_0] flex flex-row justify-center box-sizing-border">
              <p className="break-words font-['Inter'] font-[var(--text-md-medium-font-weight,500)] text-[1rem] leading-[var(--text-md-medium-line-height,1.5)] text-[var(--gray-200,#EAECF0)]">
                Settings
              </p>
            </a>
            <a href='/' className="m-[0_0.4rem_0_0] flex flex-row justify-center box-sizing-border">
              <p className="break-words font-['Inter'] font-[var(--text-md-medium-font-weight,500)] text-[1rem] leading-[var(--text-md-medium-line-height,1.5)] text-[var(--gray-200,#EAECF0)]">
                Contact
              </p>
            </a>
